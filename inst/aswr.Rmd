...
- To render the book to PDF and HTML (since it's [nested in a project directory](https://github.com/rstudio/bookdown/issues/215)), setwd and then `source('_render.R')`       
...
<!--chapter:end:02-Implementing-reproducible-research.Rmd-->
...
<!--chapter:end:03-Getting-data-into-R.Rmd-->
...
## Dealing with typos and data entry mistakes
...
<!--chapter:end:04-Preparing-the-data.Rmd-->
...
<!--chapter:end:05-Analysing-artefact-data.Rmd-->
...
<!--chapter:end:0X-Excavation-and-stratigraphic-data.Rmd-->
...
<!--chapter:end:0X-Spatial-data-and-maps.Rmd-->
