...
# if you have a CSV file, use read_csv() from the readr package
```
...
library(readr)
write_csv(table_from_docx, "data/data_output/mag-sus-data-from-Haslam_et_al_2012.csv")
```
